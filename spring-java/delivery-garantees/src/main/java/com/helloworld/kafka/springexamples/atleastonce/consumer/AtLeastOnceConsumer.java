package com.helloworld.kafka.springexamples.atleastonce.consumer;
...
public class AtLeastOnceConsumer {
    ...
    public static void main(String[] args) {
        SpringApplication app = new SpringApplication(AtLeastOnceConsumer.class);
        app.setAdditionalProfiles("at-least-once-consumer");
        app.run(args);
    }
    ...
    private void processMessage(String message) {
        ...
        if (Math.random() < 0.3) { // 10% de probabilidad de fallo
